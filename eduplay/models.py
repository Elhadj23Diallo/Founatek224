...
#modele pour stocker les reponses de l'utilisateur aux quiz
class UserAnswer(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # L'utilisateur
    question = models.ForeignKey(Question, on_delete=models.CASCADE)
    answer = models.ForeignKey(Answer, on_delete=models.CASCADE)
    attempt = models.PositiveIntegerField(default=1)  # 1 = première tentative, 2 = rattrapage
    created_at = models.DateTimeField(auto_now_add=True)
...
#modele pour stocker les reponses de l'utilisateur aux quiz
class ElectroUserAnswer(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # L'utilisateur
    question = models.ForeignKey(ElectroniqueQuestion, on_delete=models.CASCADE)
    answer = models.ForeignKey(Answer, on_delete=models.CASCADE)
    attempt = models.PositiveIntegerField(default=1)  # 1 = première tentative, 2 = rattrapage
    created_at = models.DateTimeField(auto_now_add=True)
...
#modele pour stocker les reponses de l'utilisateur aux quiz
class ArduinoUserAnswer(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # L'utilisateur
    question = models.ForeignKey(ArduinoQuestion, on_delete=models.CASCADE)
    answer = models.ForeignKey(Answer, on_delete=models.CASCADE)
    attempt = models.PositiveIntegerField(default=1)  # 1 = première tentative, 2 = rattrapage
    created_at = models.DateTimeField(auto_now_add=True)
...
#modele pour stocker les reponses de l'utilisateur aux quiz
class IotUserAnswer(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # L'utilisateur
    question = models.ForeignKey(IoTQuestion, on_delete=models.CASCADE)
    answer = models.ForeignKey(Answer, on_delete=models.CASCADE)
    attempt = models.PositiveIntegerField(default=1)  # 1 = première tentative, 2 = rattrapage
    created_at = models.DateTimeField(auto_now_add=True)
