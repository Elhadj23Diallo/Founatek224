        ...
        return [
            ...
            # ============================================================
            {
                ...
                "quiz": [
                    ...
                    {
                        "question": "À quoi sert setup() ?",
                        "a": "À exécuter du code une seule fois, au démarrage, pour l'initialisation",
                        "b": "À répéter du code à l'infini",
                        "c": "À éteindre le Wi-Fi",
                        "d": "Rien, on peut la supprimer",
                        "bonne": "A",
                        "explication": "setup() initialise le programme : connexions, broches, communication série, etc.",
                    },
                ],
            },
            # ============================================================
            {
                ...
                "quiz": [
                    {
                        "question": "Dans l'analogie du tuyau d'eau, à quoi correspond la tension ?",
                        "a": "Le débit d'eau",
                        "b": "La pression de l'eau",
                        "c": "Le diamètre du tuyau",
                        "d": "La couleur de l'eau",
                        "bonne": "B",
                        "explication": "La tension est la 'pression' qui pousse le courant à circuler dans le circuit.",
                    },
                    {
            ...
            # ============================================================
            {
                ...
                "quiz": [
                    ...
                    {
                        "question": "Combien de fils faut-il pour câbler un DHT22 sur un ESP32 ?",
                        "a": "1",
                        "b": "2",
                        "c": "3 (VCC, GND, DATA)",
                        "d": "5",
                        "bonne": "C",
                        "explication": "Alimentation (VCC), masse (GND) et un fil de donnée (DATA) suffisent.",
                    },
                    {
            ...
            # ============================================================
            {
                ...
                "quiz": [
                    ...
                    {
                        "question": "Combien de fils de communication utilise le protocole I2C ?",
                        "a": "1",
                        "b": "2 (SDA et SCL)",
                        "c": "4",
                        "d": "8",
                        "bonne": "B",
                        "explication": "I2C utilise seulement SDA (donnée) et SCL (horloge), ce qui permet de connecter plusieurs composants sur les mêmes 2 fils.",
                    },
                    {
            ...
            # ============================================================
            {
                ...
                "quiz": [
                    ...
                    {
                        "question": "Quel format de données est très couramment utilisé pour structurer l'information envoyée à une API ?",
                        "a": "JSON",
                        "b": "MP3",
                        "c": "JPEG",
                        "d": "ZIP",
                        "bonne": "A",
                        "explication": "JSON est un format texte simple, universellement compris par les serveurs web.",
                    },
                    {
